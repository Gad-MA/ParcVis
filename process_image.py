...
def parse():
    ...
    parser = argparse.ArgumentParser(
        prog="parcvis",
        description="A tool for brain parcellation visualization (ParcVis)",
    ...
    parser.add_argument(
        ...
        "--output",
        type=str,
        default="parcvis_output",
        help="Name of the output file(s) (default: parcvis_output.png/svg).\
            ...
            Needs to be either a path to scv file (like the one created by '--rich' flag), \
                or a comma separated list of cooridnates, which will be used for all components.\
                    Coordinates order should be RAS+. \
                        Be careful when using with '--components' flag: ParcVis assumes\
